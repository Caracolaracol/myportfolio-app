...
import fotoyo from '@/public/assets/images/yo4.jpg'
import fotoyo2 from '@/public/assets/images/yo3.jpg'
...
function Page() {
  ...
  return (
  <div>
      <div className="max-w-[45rem] showproject mb-12">
          <div className="mb-6">
              <div className="border-b-[1px] border-spacing-2 border-negrod border-opacity-40 dark:border-blancod dark:border-opacity-20 mb-6 transicioncorta">
          ...
          <div>
              ...
              <div className=" clear-both border-b-[1px] border-negrod border-opacity-40 dark:border-blancod dark:border-opacity-20 mt-4 mb-4 desktop:mt-6 desktop:mb-6 w-[80%] flex mx-auto">

              </div>
              <Image src={fotoyo2} alt="el fotografo posando en un bosque de litres" />
              <div className=" font-tommylight tracking-wider subpixel-antialiased clear-both border-b-[1px] border-negrod border-opacity-40 dark:border-blancod dark:border-opacity-20 mt-4 mb-4 desktop:mt-6 desktop:mb-6 w-[80%] flex mx-auto">
