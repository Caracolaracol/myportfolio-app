...
async function Page() {
  ...
  return (
    <div className="showproject">
      <div className=" border-b-[1px] border-spacing-2 border-negrod border-opacity-40 dark:border-blancod dark:border-opacity-20 mb-6 flex justify-between transitionlong">
      ...
      <p className="dark:text-blancon dark:text-opacity-80 font-tommyregular">
      ...
      <div className="border-[1px] border-spacing-2 border-negrod border-opacity-40 dark:border-blancod dark:border-opacity-10 rounded-tr-sm rounded-br-sm p-4 my-4">
